...
const InstituteCard = ({ institute }) => {
  return (
    <div className="institute-card">
      <h2 className='ih2'>{institute.instituteName}</h2>
      <p className='ip'>Location: {institute.instituteAddress}</p>
      <p className='ip'>Contact Number: {institute.mobile}</p>
      <p className='ip'>Description: {institute.instituteDescription}</p>
      <p className='ip'>Email: {institute.email}</p>
      <p className='ip'>Courses Available: {institute.noOfCoursesAvailable}</p>
